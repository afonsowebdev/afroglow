...
export type StreamImage = {
  /** Omit to render the site's placeholder tile instead of a photo. */
  src?: string
...
export function ImageStreamHero({
  ...
  return (
    <div
      className={cn('relative overflow-hidden', !children && 'pointer-events-none', className)}
      {...props}
                ...
                >
                  {img?.src ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-muted/30">
                      <i className="bx bx-image text-lg text-onyx/30" aria-hidden="true" />
                    </div>
                  )}
                </div>
              )

        ...
        {loadFailed ? (
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
            <div className="order-first lg:order-last lg:sticky lg:top-32 lg:self-start">
              <div className="relative flex h-56 w-full items-center justify-center overflow-hidden rounded-2xl bg-muted/30 sm:h-72">
            ...
            <ul>
              {services.map((service, index) => {
                ...
                return (
                  <li key={service.id} className="border-b border-gold/20">
                    <button
                      type="button"
